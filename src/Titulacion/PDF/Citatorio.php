...
class Titulacion_PDF_Citatorio extends External_FPDF {
	...
	function renderBase () {
		...
		$this->Image (dirname(__FILE__).'/data/udg/nuevoMembrete_cabecera.jpg', 0, 0, 216, 0);
		...
		$cad = $grado.' '.$this->secretario->nombre.' '.$this->secretario->apellido;
		$this->Cell (156, 0, $cad, 0, 0, 'C');


		$this->SetY (210); $this->SetX (41);
		$this->Cell (156, 0, 'Sectreario', 0, 0, 'C');

		$this->Image (dirname(__FILE__).'/data/udg/nuevoMembrete_pie.jpg', 0, 255, 216, 0);
	}
}
