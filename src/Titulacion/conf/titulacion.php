...
$cfg['secret_key'] = 'q6cUvHXZgxVekahAO2Ej3f3YrBCqNECoRTU3OJZMhyfV4CNgw+rwzwfU+stD7';
...
$cfg['from_email'] = 'titulacion@cucei.udg.mx';

# Email address for the bounced messages.
$cfg['bounce_email'] = 'titulacion@cucei.udg.mx';
